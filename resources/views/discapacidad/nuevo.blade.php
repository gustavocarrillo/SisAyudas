...
@section('contenido')
    ...
    <div class="x_title">
        ...
        <div class="x_content">
            ...
            <form action="{{ route('guardar-discapacidad') }}" method="POST" class="form-horizontal form-label-left">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5 col-sm-3 col-xs-8">
                        <input type="text" id="discapacidad" name="discapacidad" value="" class="form-control col-md-3 col-xs-8" required="required">
                    </div>
                </div>
