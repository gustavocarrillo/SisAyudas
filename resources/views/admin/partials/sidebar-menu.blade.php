<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            {{--<li><a href="{{ route('buscar-ayudas') }}"><i class="fa fa-home"></i> Ayudas</a></li>--}}
            <li><a><i class="fa fa-users"></i> Ayudas <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    <li><a href="{{ route('listar-solicitantes') }}">Busqueda General</a></li>
                    <li><a href="{{ route('ayudas-naturales') }}">Persona Natural</a></li>
                    <li><a href="{{ route('ayudas-instituciones') }}">Instituciones - Consejos Comunales</a></li>
            ...
            <li><a><i class="fa fa-wheelchair"></i>Discapacidad</a>
                <ul class="nav child_menu">
                    <li><a href="{{ route('nueva-discapacidad') }}">Nueva Discapacidad</a></li>
                    <li><a href="{{ route('listar-discapacidad')  }}">Ver Discapacidades</a></li>
                </ul>
            </li>
