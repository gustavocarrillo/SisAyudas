...
@section('contenido')
    ...
    <div class="x_title">
        ...
        <div class="x_content">
            ...
            <form action="{{ route('editado-municipio') }}" method="POST" class="form-horizontal form-label-left">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12">
                        <input type="text" id="nombre" name="nombre" value="{{ $municipio->nombre }}" class="form-control col-md-7 col-xs-12" required="required">
                    </div>
                </div>
